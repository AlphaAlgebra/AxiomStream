...
class SymbolicStateVerifier:
    def __init__(self):
        ...
        self.invariant_total_funds = sp.Eq(self.balance_a + self.balance_b, self.initial_total)
    ...
    def verify_transaction_safety(self, transfer_amount_expr: str) -> dict:
        ...
        is_volume_preserved = sp.simplify(new_total_funds) == sp.simplify(self.invariant_total_funds)
