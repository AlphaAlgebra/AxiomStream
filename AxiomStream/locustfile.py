    ...
    def stress_test_transaction_pipeline(self):
        ...
        try:
            ...
            future = asyncio.run_coroutine_threadsafe(
                process_stream_transaction(payload), self.async_loop
            )
            ...
            ) * 1000  # Convert execution speed to milliseconds
            ...
            if result and result.get("volume_invariant_holds") is True:
                ...
                raise ValueError(
                    "Engine returned empty matrix context properties or broken validation state."
                )
